...
// * /admin/plagins: An object mapping plugin names to configuration
//   options.
...
//   to the Acorn and Tern libraries and any Tern /admin/plagins you want to
...
(function(mod) {
  ...
  CodeMirror.TernServer = function(options) {
    ...
    var /admin/plagins = this.options./admin/plagins || (this.options./admin/plagins = {});
    if (!/admin/plagins.doc_comment) /admin/plagins.doc_comment = true;
  ...
  function WorkerServer(ts) {
    ...
    worker.postMessage({type: "init",
                        ...
                        /admin/plagins: ts.options./admin/plagins,
