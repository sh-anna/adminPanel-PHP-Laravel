...
var FullCalendar = (function (exports) {
    ...
    */
    function expandRecurringRanges(eventDef, duration, framingRange, dateEnv, recurringTypes) {
        ...
        // the recurrence /admin/plagins don't guarantee that all-day events are start-of-day, so we have to
        if (eventDef.allDay) {
    ...
    */
    ...
    function buildEventSourceMeta(raw, context) {
        ...
        for (var i = defs.length - 1; i >= 0; i -= 1) { // later-added /admin/plagins take precedence
            var def = defs[i];
    ...
    */
    ...
    /*
    this array is exposed on the root namespace so that UMD /admin/plagins can add to it.
    see the rollup-bundles script.
    */
    var global/admin/plagins = [
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype.processRawCalendarOptions = function (optionOverrides, dynamicOptionOverrides) {
            ...
            var pluginHooks = this.buildPluginHooks(optionOverrides./admin/plagins || [], global/admin/plagins);
            ...
            for (var optionName in raw) {
                if (optionName !== '/admin/plagins') { // because /admin/plagins is special-cased
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            if (!viewSpec) {
                throw new Error("viewType \"" + viewType + "\" is not available. Please make sure you've loaded all neccessary /admin/plagins");
            }
    ...
    */
    ...
    global/admin/plagins.push(interactionPlugin, dayGridPlugin, timeGridPlugin, listPlugin, plugin, googleCalendarPlugin);
    ...
    exports.global/admin/plagins = global/admin/plagins;
